...
ostream& operator<<(ostream& os, Employee& e) {
    os << e.eno << ", " << e.getPid() << ", " << e.getPname() << ", " << e.getDname() << ", " << e.getCity() << endl;
    return os;
}
...
ostream& operator<<(ostream& os, Student s) {
    os << s.getSid() << ", " << s.getDname() << ", " << s.getCity() << ", " << s.getPid() << ", " << s.getPname() << endl;
    return os;
}
...
ostream& operator<<(ostream& os, Coder& c) {
    os << c.getEno() << ", " << c.getPid() << ", " << c.getPname() << ", " << c.getDname() << ", " << c.getCity() << ", " << c.language << ", " << c.workYears << endl;
    return os;
}
...
ostream& operator<<(ostream& os, PartTimeStudent& pts) {
    os  << pts.getEno() << ", " << pts.getSid() << ", " << pts.getPid() << ", " << pts.getPname() << ", " << pts.Employee::getDname() << ", " << pts.Employee::getCity() << ", " << pts.salary << ", " << pts.grade << endl;
    return os;
}
